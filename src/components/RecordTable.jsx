                  ...
                  >
                    ...
                    <td className="px-6 flex gap-2 py-4">
                      ...
                      <button
                        ...
                        type="button"
                        className="text-white bg-red-700 hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                      >
                        Delete
                      </button>
                    </td>
